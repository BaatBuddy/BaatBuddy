...
sealed class Screen(val route: String, val icon: Any, val label: String) {
    ...
    object InfoScreen : Screen(route = "infoscreen", icon = R.drawable.baseline_weather_24, label = "Været")
    object TrackingScreen :
        Screen(route = "trackingscreen", icon = R.drawable.baseline_record, label = "Spor")

    object RouteScreen : Screen(route = "routescreen", icon = R.drawable.baseline_route, label = "Ruter")
